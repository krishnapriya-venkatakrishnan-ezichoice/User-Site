...
export default function Page() {
        ...
        <div className="">
          {type === "date" ? (
            <DatePicker
              ...
              onChange={(date) => formik.setFieldValue(formikFieldName, date)}
  ...
  return (
    <div className="flex min-h-full flex-col justify-center px-2 py-3 lg:px-8 border border-gray-200 rounded-lg shadow-lg max-w-5xl mx-auto bg-whiet">
